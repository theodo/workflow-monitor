...
import { ExecutionResult, GraphQLSchema, ValidationContext, ASTVisitor } from 'graphql';
...
import { APIGatewayWebSocketEvent, IConnectionManager, ISubscriptionManager } from './types';
