...
import { GET_CURRENT_PROJECT_WITH_LIST } from '../../Apollo/Queries/Projects';
...
class Home extends PureComponent {
  ...
  render() {
    return (
      <Query query={GET_CURRENT_PROJECT_WITH_LIST}>
        {({ data: { currentProject }, loading }) => {
